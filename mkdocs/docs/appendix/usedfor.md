...
* [Reflow](https://reflowproject.eu/) was an EU funded project that seeks to understand and transform urban material flows, co-create and test regenerative solutions at business, governance, and citizen levels to create a resilient circular economy.  The ReflowOS backend was developed by Dyne (see below), forked from the Bonfire application. Here's a [ReflowOS video](https://www.youtube.com/watch?v=BIMyOM5msgA) including some municipal pilots. (Complete.)
