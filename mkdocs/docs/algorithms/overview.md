...
*All of the Algorithms sections are non-normative.*
...
* **Dependent Demand** constructs schedules for operational economic networks from recipes
    ...
    * [Gantt charts](https://en.wikipedia.org/wiki/Gantt_chart){target="_blank"} are a popular network schedule visualization.
...
* **Economic and Ecosystem Analysis**:
    ...
    * [System Dynamics](https://en.wikipedia.org/wiki/System_dynamics){target="_blank"}
    * [Systems Ecology](https://en.wikipedia.org/wiki/Systems_ecology){target="_blank"}, including [Energy Flow Analysis](https://en.wikipedia.org/wiki/Energy_flow_(ecology)){target="_blank"}
    * [Input-Output Analysis](https://en.wikipedia.org/wiki/Input%E2%80%93output_model){target="_blank"}
    * [Environmentally Extended IPO Analysis](https://en.wikipedia.org/wiki/Environmentally_extended_input-output_analysis){target="_blank"}
    * [Material Flow Analysis](https://en.wikipedia.org/wiki/Material_flow_analysis){target="_blank"}
...
* **Network Flows** is a general name for all of those algorithms and many many more. See [Flow Networks](https://en.wikipedia.org/wiki/Flow_network){target="_blank"} on Wikipedia and elsewhere.
...
* The Economic and Ecosystem algorithms use [Input-Process-Output Models](https://en.wikipedia.org/wiki/IPO_model){target="_blank"}
...
* [Agent-Based Models](https://en.wikipedia.org/wiki/Agent-based_model){target="_blank"}

    * [In biology](https://en.wikipedia.org/wiki/Agent-based_model_in_biology){target="_blank"}
    * [In economics](https://en.wikipedia.org/wiki/Agent-based_computational_economics){target="_blank"}
    * [In sociology](https://en.wikipedia.org/wiki/Computational_sociology){target="_blank"}, including [Social Network Analysis](https://en.wikipedia.org/wiki/Social_network_analysis){target="_blank"}

* [Complex adaptive systems](https://en.wikipedia.org/wiki/Complex_adaptive_system){target="_blank"}
